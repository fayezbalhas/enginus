    ...
    <main style={{ background: '#0a0a0a', color: '#f0f0f0', fontFamily: "'Inter', sans-serif", minHeight: '100vh' }}>
      ...
      <section style={{ minHeight: 'calc(100vh - 64px)', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '80px 24px' }}>
        <div style={{ maxWidth: '600px' }}>
          <span style={{ fontSize: '40px', color: '#cc0000', display: 'inline-block', marginBottom: '20px' }}>&#10687;</span>
          ...
          <p style={{ fontSize: '17px', color: '#666', lineHeight: 1.7 }}>
            Calculate rebar areas, number of bars and spacing for any diameter, with support for EC and ACI bar designations. This tool is in development &mdash; check back soon.
          </p>
          <a href="/calculators" className="btn-primary" style={{ marginTop: '32px' }}>&larr; Back to Calculators</a>
        </div>
      </section>
    </main>
  )
